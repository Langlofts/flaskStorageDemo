...
class BlobSamples(object):
    ...
    connection_string = "DefaultEndpointsProtocol=https;AccountName=pydemostore;AccountKey=EDI1bZePwltDk6slUoVAd/TUAhBSmCEv60WQK24+PsDsRXnZq6mRuB5HFROGOQFDYq8TXRsUpI/o38lR2HEbeA==;EndpointSuffix=core.windows.net"
    ...
    def create_container_sample(self):
        ...
        container_client = blob_service_client.get_container_client("profilepic")
